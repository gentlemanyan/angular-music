  ...
  return {
    ...
    entry: {
      ...
      'main':      AOT ? './src/main.browser.aot.ts' :
                  './src/main.browser.ts',
      'vendor': './node_modules/ng-zorro-antd'
    ...
    module: {
      ...
      rules: [
        ...
        {
          test: /\.less$/,
          use: ['to-string-loader'].concat(ExtractTextPlugin.extract({fallback:'style-loader', use: ['css-loader', 'less-loader']})),
    ...
    plugins: [
      ...
      */
      ...
      new ExtractTextPlugin('main-less.css')
    ],
